#!/usr/bin/env bash
# examples/opencode/statusline_example.sh
#
# Drop-in example showing how to wire the OpenCode statusline into bash or zsh.
#
# Usage:
#   1. Copy or source this file from your ~/.bashrc or ~/.zshrc:
#        source /path/to/statusline-scripts/examples/opencode/statusline_example.sh
#   2. Reload your shell:
#        exec "$SHELL"
#
# Customization:
...
source "$_EXAMPLE_DIR/../../scripts/opencode/statusline.sh"
