...
- **インストール:** OpenCode がセッション開始時に `opencode-subagent-statusline@0.6.1` を npm からロードします（`opencode.json` の `plugin` 配列に追加）
...
- **インストール:** `npx --ignore-scripts -y ccstatusline-usage@2.4.1`
...
- **インストール:** `npx --ignore-scripts -y tokscale@2.1.0`
